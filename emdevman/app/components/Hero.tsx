...
export default function Hero() {
  return (
    ...
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-background text-foreground transition-colors duration-300 ease-in-out">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] items-center">
          ...
          <div className="flex items-center justify-center">
            {/* Added transition to border as well */}
            <div className="relative aspect-square overflow-hidden rounded-full border-2 border-zinc-100 dark:border-zinc-800 md:aspect-[4/4] md:w-[400px] transition-colors duration-300">
              <Image
                ...
                width={400}
                height={400}
                className="object-cover w-full h-full dark:invert transition-all duration-300"
                priority
              />
            </div>
          </div>
